...
/* 테이블 코멘트 */
COMMENT ON TABLE query_patterns IS 'NL2SQL 메타데이터: 쿼리 패턴 템플릿';
...
COMMENT ON TABLE pattern_parameters IS 'NL2SQL 메타데이터: 패턴 파라미터';
...
COMMENT ON TABLE pattern_keywords IS 'NL2SQL 메타데이터: 패턴 매칭 키워드';
