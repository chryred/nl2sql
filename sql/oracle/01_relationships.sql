/* 
============================================================================
NL2SQL 메타데이터 테이블: 테이블 관계 및 네이밍 컨벤션 정의 (Oracle)
============================================================================
*/
...
/* 테이블 및 컬럼 코멘트 */
COMMENT ON TABLE table_relationships IS 'NL2SQL 메타데이터: FK 없는 테이블 간 관계 수동 정의';
...
CREATE TABLE naming_conventions (
    ...
    apply_to_schemas        CLOB,        /* JSON 형태로 저장 */
...
COMMENT ON TABLE naming_conventions IS 'NL2SQL 메타데이터: 컬럼명 기반 관계 추론 규칙';
