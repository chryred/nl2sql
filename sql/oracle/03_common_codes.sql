...
/* 테이블 코멘트 */
COMMENT ON TABLE code_tables IS 'NL2SQL 메타데이터: 공통코드 테이블 위치 및 구조';
...
COMMENT ON TABLE column_code_mapping IS 'NL2SQL 메타데이터: 컬럼-코드그룹 매핑';
...
COMMENT ON TABLE code_aliases IS 'NL2SQL 메타데이터: 공통코드 동의어/별칭';
