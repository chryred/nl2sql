...
DATAFILE '/opt/oracle/oradata/XE/AMUS/ts_appuser.dbf'
SIZE 100M
AUTOEXTEND ON NEXT 50M MAXSIZE 1G;

ALTER USER APPUSER DEFAULT TABLESPACE TS_APPUSER;
ALTER DATABASE DEFAULT TABLESPACE TS_APPUSER;
ALTER USER APPUSER QUOTA UNLIMITED ON TS_APPUSER;

CREATE USER nl2sql IDENTIFIED BY nl2sql
...
ALTER USER NL2SQL ACCOUNT UNLOCK;
...
CREATE TABLESPACE TS_NL2SQL
DATAFILE '/opt/oracle/oradata/XE/AMUS/ts_nl2sql.dbf' 
SIZE 100M 
AUTOEXTEND ON NEXT 50M MAXSIZE 1G;

ALTER USER nl2sql DEFAULT TABLESPACE TS_NL2SQL;
--ALTER DATABASE DEFAULT TABLESPACE TS_NL2SQL;
ALTER USER nl2sql QUOTA UNLIMITED ON TS_NL2SQL;

/* 테이블 이동 */
/* ALTER TABLE table_relationships MOVE TABLESPACE TS_NL2SQL; */

/* 인덱스도 함께 이동해줘야 성능이 유지됩니다 */
/*ALTER INDEX uk_table_rel REBUILD TABLESPACE TS_NL2SQL; */
